...
<section 
  class="h-[80vh] rounded-xl flex items-end mx-12 justify-start relative"
  style="
...
>
  <div class="absolute inset-0 bg-gradient-to-r from-gs-dark-green/90 via-gs-dark-green/50 to-transparent rounded-xl"></div>
  <div class="px-6 md:px-8 relative z-10">
    <div class="space-y-4 pt-32 mb-12 md:mb-16 md:ml-8">
      <h1 class="text-2xl sm:text-2xl lg:text-5xl font-bold text-white leading-tight drop-shadow-lg mb-4 font-body">
      ...
      <div class="flex flex-col md:flex-row gap-4 md:gap-8 pt-8">
        <a 
          href="/visit" 
