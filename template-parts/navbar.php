<!-- Wrapper for shared Alpine.js state between navbar and mobile menu -->
<div x-data="{ isOpen: false }" x-effect="document.body.style.overflow = isOpen ? 'hidden' : ''">
  ...
  <!-- Mobile Navigation Overlay - OUTSIDE nav tag to escape z-index stacking context -->
  <div x-show="isOpen" 
