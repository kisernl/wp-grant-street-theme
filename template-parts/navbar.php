<nav class="absolute top-0 left-0 right-0 p-4 z-50 transition-all duration-300 md:rounded-lg bg-gs-off-white/50 backdrop-blur-md" x-data="{ isOpen: false }" style="isolation: isolate;">
  <div class="mx-auto md:px-8 px-4 py-0 text-primary">
    ...
    <div x-show="isOpen" 
         ...
         class="lg:hidden pb-6 border-t border-primary/20 bg-gs-off-white/90 mt-6 backdrop-blur-md rounded-lg">
      <div class="flex flex-col space-y-6 pt-6 px-6">
        <?php
        wp_nav_menu([
          'theme_location' => 'primary',
          'container' => false,
        ...
        ?>
        <div class="flex items-center space-x-8">
          <a href="/visit" class="w-full text-lg font-sans text-button font-bold">Visit</a>
        </div>
      </div>
    </div>
  </div>
